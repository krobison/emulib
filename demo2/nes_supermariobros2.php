...
<html lang="en">
  ...
  <body>
	...
	<ol class="breadcrumb">
		...
		<li><a href="#">NES</a></li>
		<li class="active">Super Mario Bros. 2</li>
	</ol>
		...
		<div class="panel-body">
			...
			<div id="info">
				<div id="pictureholder">
						<a class="thumbnail" href="assets/img/nes_supermariobros2.jpg" title="Super Mario Bros. 2 Box Art">
							<img src="assets/img/nes_supermariobros2.jpg"/>
						</a>
				</div>
				<div id="infotable">
					<table class="table">
						...
						<tr>
							<td>Cartridge</td>
							<td id="mediacart">
								<a id="media" class="thumbnail" href="assets/img/nes_cart_supermariobros2.jpg" title="Super Mario Bros.3 Cartridge">
									<img src="assets/img/nes_cart_supermariobros2.jpg"/>
								</a>
							</td>
						</tr>
						<tr>
							<td>Manual</td>
							<td>
								<a id="media" class="thumbnail" href="assets/img/nes_manual_supermariobros2.pdf" title="Super Mario Bros.3 Cartridge">
									<img src="assets/img/nes_manthumb_supermariobros2.jpg"/>
								</a>
							</td>
						</tr>
					</table>
...
After Nintendo of America had concluded that the Japanese Super Mario Bros. 2 was too difficult, they chose instead to help the original development staff to redevelop Yume Kōjō: Doki Doki Panic back into a Super Mario Bros. sequel. The game became a commercial success, and eventually the game became well received enough that it was also released in Japan for the Family Computer itself as Super Mario USA. Since its successful sales yield, Super Mario Bros. 2 has been considered a classic Super Mario Bros. game worldwide, including Japan.<br><br>
				...
				<div id="ratingsection">
					<div id="ratingtable">
						<table class="table">
							...
							<tr>
								<td>Gamespot</td>
								<td class="goodRating">8.0/10</td>
							</tr>
							<tr>
								<td>IGN</td>
								<td class="goodRating">8.5/10</td>
							</tr>
							<tr>
				...
				<div id="screens">
					<!--<div class="col-xs-6 col-md-2">
						<a class="thumbnail" href="assets/img/nes_screen_supermariobros2_1.jpg" id="screenthumb" title="Mario on an Airship">
							<img src="assets/img/nes_screen_supermariobros2_1.jpg"/>
						</a>
					</div>
					<div class="col-xs-6 col-md-2">
						<a class="thumbnail" href="assets/img/nes_screen_supermariobros2_2.jpg" id="screenthumb" title="Super Mario Bros.3 W1-L3">
							<img src="assets/img/nes_screen_supermariobros2_2.jpg"/>
						</a>
					</div>
					<div class="col-xs-6 col-md-2">
						<a class="thumbnail" href="assets/img/nes_screen_supermariobros2_3.jpg" id="screenthumb" title="Mario in the Desert">
							<img src="assets/img/nes_screen_supermariobros2_3.jpg"/>
						</a>
					</div>
					<div class="col-xs-6 col-md-2">
						<a class="thumbnail" href="assets/img/nes_screen_supermariobros2_4.jpg" id="screenthumb" title="Big World">
							<img src="assets/img/nes_screen_supermariobros2_4.jpg"/>
						</a>
					</div>
					<div class="col-xs-6 col-md-2">
						<a class="thumbnail" href="assets/img/nes_screen_supermariobros2_5.jpg" id="screenthumb" title="High in the sky">
							<img src="assets/img/nes_screen_supermariobros2_5.jpg"/>
						</a>
					</div>
					<div class="col-xs-6 col-md-2">
						<a class="thumbnail" href="assets/img/nes_screen_supermariobros2_6.jpg" id="screenthumb" title="Frog Suit">
							<img src="assets/img/nes_screen_supermariobros2_6.jpg"/>
						</a>
					</div>
					<div class="col-xs-6 col-md-2">
						<a class="thumbnail" href="assets/img/nes_screen_supermariobros2_7.jpg" id="screenthumb" title="World 8">
							<img src="assets/img/nes_screen_supermariobros2_7.jpg"/>
						</a>
					</div>-->
					<div class="media">
						<a class="pull-left" href="assets/img/nes_screen_supermariobros2_1.jpg">
							<img class="media-object" src="assets/img/nes_screen_supermariobros2_1.jpg" alt="Pow Block" title="Using a POW block">
						</a>
						<div class="media-body">
							<h4 class="media-heading">Brand New POW Block</h4>
								<span>For those pesky enemies!</span>
						</div>
					</div>
					<div class="media">
						<a class="pull-left" href="assets/img/nes_screen_supermariobros2_2.jpg">
							<img class="media-object" src="assets/img/nes_screen_supermariobros2_2.jpg" alt="Playing as Peach" title="Playing as Peach">
						</a>
						<div class="media-body">
							<h4 class="media-heading">Play as Peach!</h4>
								<span>There are several characters to choose from.</span>
						</div>
					</div>
					<div class="media">
						<a class="pull-left" href="assets/img/nes_screen_supermariobros2_3.jpg">
							<img class="media-object" src="assets/img/nes_screen_supermariobros2_3.jpg" alt="Birdo" title="Birdo">
						</a>
						<div class="media-body">
							<h4 class="media-heading">Fight some crazy egg-spitting guy!</h4>
								<span>Seriously. It's a guy. Read the manual.</span>
						</div>
					</div>
				</div>
				<br><br>
				...
				<div id="jp_container_1" class="jp-audio">
					<div class="jp-type-single">
						<div class="jp-gui jp-interface">
							...
							<div class="jp-title">
								<ul>
									<li>Super Mario Bros. 2 - Overworld</li>
								</ul>
							</div>
		...
		$(document).ready(function(){
			$("#jquery_jplayer_1").jPlayer({
				...
				$(this).jPlayer("setMedia", {
					mp3: "sound/nes_supermariobros2_1.mp3",
				});
			},
			swfPath: "jplayer",
			supplied: "mp3"
